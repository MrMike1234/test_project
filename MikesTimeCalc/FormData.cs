...
namespace MikesTimeCalc
{
    ...
    public class FormData
    {
        ...
        /// </summary>
        /// 
        public static SortedDictionary<string, string> config = new SortedDictionary<string, string>();
        const string FileName = "mikes_config.xml";
        ...
        public string LogDir
        {
            get
            {
                ...
                {
                    dir = Application.StartupPath + "//mikeslog.txt"; ;
                }
                return dir;
            }
            set
        ...
        public void Save()
        {
            ...
            using (XmlTextWriter xmlwriter = new XmlTextWriter(filename, Encoding.UTF8))
            {
                ...
                xmlwriter.WriteStartElement("FormData");
